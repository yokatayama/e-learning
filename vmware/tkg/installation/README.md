...
- ProLiant SL210t Gen8 x4
  - Intel(R) Xeon(R) CPU E5-2640 v2 @ 2.00GHz (32vCore)
  - RAM 128GB
  - HDD: 1TB HW RAID1
...
手順に従い、次はTanzuコマンドプラグインをインストールします。初めにTanzu CLIのtarを解凍したフォルダー(*cli*フォルダーがある場所)に移動します。本検証環境の場合、Desktop常にworkというフォルダーを作ったのでcmdでそこに移動します。
...
プロンプトが帰ってきましたら、以下のコマンドでプラグインがインストールされたかを確認します。
